...
function mostraAlternativas() {
    for(const alternativa of perguntaAtual.alternativas) {
        const botaoAternativa = document.createElement("button");
        botaoAternativa.textContent = alternativa.texto;
        botaoAternativa.addEventListener("click", function(){
            atual++;
            mostraPergunta();
        });
        caixaAlternativas.appendChild(botaoAternativa);
    }
}
